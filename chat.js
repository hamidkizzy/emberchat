document.addEventListener('DOMContentLoaded', async () => {
  ...
  // Safety net: iOS home-screen "installed" apps sometimes don't fire
  // visualViewport events as reliably as Safari-in-browser does. When any
  // text input gets focus/blur (keyboard opening/closing), poll for a
  // short burst to make sure we catch the real settled height either way.
  function pollAppHeight(durationMs = 900, intervalMs = 80) {
  ...
  document.addEventListener('focusin', (e) => {
    if (e.target.matches('input, textarea')) pollAppHeight();
  });
